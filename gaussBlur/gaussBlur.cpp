...
//高斯平滑：返回的数据类型是浮点型
Mat
gaussBlur(const Mat &image, Size winSize, float sigma, Point anchor = Point(-1, -1), int borderType = BORDER_DEFAULT) {
    //卷积核的宽高均为奇数
