...
void callback_thresh(int, void *) {
    ...
    imshow("threshold strengh1", thresh_edge);
...
int main(int argc, char *argv[]) {
    ...
    imshow("135 edge", abs_img_roberts_1);
    imwrite("img_robert_135_edge.jpg", abs_img_roberts_1);
    imshow("45 edge", abs_img_roberts_2);
    ...
    //阈值处理后的边缘强度
    namedWindow("threshold strengh", cv::WINDOW_AUTOSIZE);
