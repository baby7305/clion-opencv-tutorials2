...
int main(int argc, char *argv[]) {
    ...
    imshow("perpendicular edge", abs_img_scharr_x);
    imwrite("img1_sch_v_edge.jpg", abs_img_scharr_x);
    imshow("horizontal edge", abs_img_scharr_y);
    ...
    createTrackbar("threshold", "threshold edge strengh", &Thresh, MAX_THRESH, callback_thresh);
    callback_thresh(0, 0);
    waitKey(0);
    return 0;
}